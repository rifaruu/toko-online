    ...
    <div class="container mt-5">
        ...
        <div class="col-12 col-md-6 mb-5">
            ...
            <div>
                ...
                <input type="text" id="nama" name="nama" value="<?php echo htmlspecialchars($data['nama']); ?>" class="form-control" autocomplete="off" >
            </div> 
            ...
            ?>
                <div class='alert alert-warning'>Nama, kategori dan harga wajib diisi!</div>
            <?php   
                } else {
            ...
            <?php                 
                                ...
                                if(move_uploaded_file($_FILES["foto"]["tmp_name"], $target_file)){
                                    $queryUpdate = mysqli_query($con, "UPDATE produk SET foto='$target_file' WHERE id='$id'");
            ...
            ?>
                                    <div class="alert alert-danger mt-3" role="alert">Gagal mengupload file!</div>
            <?php
                                }
                            }
                        }
            ...
            if(isset($_POST['hapus'])){
                ...
                if($queryHapus){
            ?>
                    <div class="alert alert-primary mt-3" role="alert">Produk berhasil dihapus
                    </div>
                    <meta http-equiv="refresh" content="2; url=produk.php" />
            <?php
